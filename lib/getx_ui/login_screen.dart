                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            prefixIcon: const Icon(Icons.account_circle_outlined,color: Color(0xff767676),size: 35,),
                        ...
                        TextFormField(
                          ...
                          decoration: InputDecoration(
                              ...
                              prefixIcon: const Icon(Icons.lock_rounded,color: Color(0xff767676),size: 30,),
                              suffixIcon: InkWell(
                                onTap: (){},
                                child:  const Icon(Icons.remove_red_eye_outlined,color: Color(0xff767676),size: 30,),
                              ),
